...
export const options = {
  stages: [
    { duration: '30s', target: 10 },  // 暖身：30 秒內逐步增加到 10 人
    { duration: '1m', target: 10 },   // 穩定：維持 10 人 1 分鐘
    { duration: '30s', target: 15 },  // 尖峰：30 秒內增加到 15 人
    { duration: '30s', target: 0 },   // 冷卻：30 秒內降到 0 人
  ],
  thresholds: {
    http_req_duration: ['p(95)<5000'], // 95% 的請求應在 5 秒內完成
  },
};
